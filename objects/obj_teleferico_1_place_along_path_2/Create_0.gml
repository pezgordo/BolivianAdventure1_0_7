...
var p = 0;
var n = 17 // change to match how many trees to place evenly along the path
repeat n {
    var xx = path_get_x(path_teleferico_2, p);
    var yy = path_get_y(path_teleferico_2, p);
    with(instance_create_layer(xx, yy, "teleferico_vuelta", obj_teleferico_1))
	{
		tpath = 2;	
	};
    p += 1/n;
