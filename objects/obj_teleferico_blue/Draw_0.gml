...
if (tpath = 1)
{
draw_sprite_ext(spr_teleferico_blue, 0, self.x, self.y, escala, escala, 0, c_white, image_alpha);
}
...
if (montable = true) 
{
	...
	if (tpath = 2)
	{
		draw_rectangle_color(x + ((42-62) * escala), y + ((123-22) * escala), x + ((111-62) * escala), y + ((142-22) * escala), c_green, c_green, c_lime, c_lime, 0); 
	}
...
else 
{
	...
	if (tpath = 2)
	{
		draw_rectangle_color(x + ((42-62) * escala), y + ((123-22) * escala), x + ((111-62) * escala), y + ((142-22) * escala), c_red, c_red, c_red, c_red, 0); 
	}
...
//draw_text(x + 50, y + 50, "vsp: " + string(vsp));
//draw_text(x + 50, y + 70, "hsp: " + string(hsp));
