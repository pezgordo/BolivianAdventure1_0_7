...
var p = 0;
var n = 15 // change to match how many trees to place evenly along the path
repeat n {
    var xx = path_get_x(path_teleferico_1, p);
    var yy = path_get_y(path_teleferico_1, p);
    with(instance_create_layer(xx, yy, "teleferico_ida", obj_teleferico_1))
	{
		tpath = 1;
	};
    p += 1/n;
