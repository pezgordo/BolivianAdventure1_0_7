...
//if (tpath = 1)
//{
	draw_sprite_ext(spr_teleferico_red, 0, self.x, self.y, escala, escala, 0, c_white, image_alpha);
	...
	if (flash > 0)
	{
		...
		//shader_set(sh_white);
		draw_sprite_ext(spr_teleferico_red, 0, self.x, self.y, escala, escala, 0, c_white, 1);
...
if (tpath = 2)
{
draw_sprite_ext(spr_teleferico_1, 0, self.x, self.y, -(escala), escala, 0, c_white, 1);
}
*/
